function setUpInput() {
    ...
    nameInput.position(2 * width / 4 + 200, height / 5 - 18);
    ...
    heButton.position(2 * width / 4 + 220 + 50, height / 5 + 35);

    sheButton = createCheckbox("she/her");
    sheButton.position(2 * width / 4 + 220 + 115, height / 5 + 35);

    theyButton = createCheckbox("they/them");
    theyButton.position(2 * width / 4 + 220 + 183, height / 5 + 35);
}
